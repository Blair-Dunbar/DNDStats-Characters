...
HalflingSubrace = ('Lightfoot', 'Stout') #2 Items
...
ClericSubclass = ('Ambition', 'Arcana', 'City', 'Death', 'Forge', 'Grave', 'Knowledge', 'Life', 'Light', 'Nature', 'Protection', 'Solidarity', 'Strength', 'Tempest', 'Trickery', 'War', 'Zeal') #17 Items
...
WarlockSubclass = ('The Archfey', 'The Celestial', 'The Fiend', 'Ghost in the Machine', 'The Great Old One', 'The Hexblade', 'The Raven Queen', 'The Seeker', 'The Undying') #9 Items
WizardSubclass = ('Bladesinging', 'Lore Mastery', 'School of Abjuration', 'School of Conjuration', 'School of Divination', 'School of Enchantment', 'School of Evocation', 'School of Illusion', 'School of Necromancy', 'School of Transmutation', 'School of Invention', 'Technomancy', 'Theurgy', 'War Magic') #14 Items
...
def dndrc():
    ...
    warlocksubc = random.randint(0,8)
    Wizardsubc = random.randint(0,13)
    ...
    if r3 == 13:
        print ('Wizard Subclass is ' + wizsc)
...
Button = Button(root, text='Generate', command = change)
Button.pack()
